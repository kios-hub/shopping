...
public class DataSourceConfig {
	...
	private Integer initialSize;//初始连接数6
	@Bean
	@Primary //当容器中存在多个同类对象，优先使用有@Primary的
	public DataSourceConfig initDruidDataSource(){
		...
		dsc.setMaxActive(maxActive);
		dsc.setMaxIdle(maxIdle);
		dsc.setMinIdle(minIdle);
		dsc.setInitialSize(initialSize);
		return dsc;
	}
